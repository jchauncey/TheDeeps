...
func UpdateUIDimensions(size TerminalSize) {
	...
	MapViewHeight = height - MessageLogHeight - 5 // Leave room for messages and borders
	...
	// Debug output
	fmt.Printf("UI dimensions updated: Window(%d,%d), Map(%d,%d), Char(%d,%d)\n",
		WindowWidth, WindowHeight, MapViewWidth, MapViewHeight, CharPanelWidth, CharPanelHeight)
}
